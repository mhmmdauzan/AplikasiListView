package id.ac.poliban.mi.auzan.aplikasilistview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // daftarkan view untuk di manipulasi
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> Toast.makeText(this, "Anda Mengklik " + countries.get(position), Toast.LENGTH_SHORT).show());
    }
}
